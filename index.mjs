...
import { create300x200Circle } from "./lib/shape/circle.mjs";
...
while (answers.confirm === false) {
    ...
    const answersToEdit = await inquirer.prompt(answersToEditQuestion, answers)
    ...
    if (answersToEdit.length !== 0) {
        ...
        answers = Object.assign(Object.assign({}, answers), newAnswers);
    }
